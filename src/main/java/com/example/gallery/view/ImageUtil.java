...
public class ImageUtil {
     ...
     * @return
     */
    public static Bitmap getImageBitmap(String path, int resID) {
        ...
        Log.i(TAG, "重新加载");
        Bitmap invertBitmap = getInvertBitmap(path, resID);
     ...
     * @return
     */
    public static Bitmap getInvertBitmap(String path, int resID) {
        // 1.获取原图
